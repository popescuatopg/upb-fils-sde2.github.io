...
#### [pwd]((https://linux.die.net/man/1/pwd)) - Affiche le chemin complet du directoire courant
     
##### Exemple
```bash
$ rustybox pwd
/home/pi/my_directories
#### [echo]((https://linux.die.net/man/1/echo) - Affiche les arguments de la console, suivies par une nouvelle ligne 
 ...
 * #### mkdir directoires - Crée les directoires envoyés comme parametre, s'ils n'existent pas. Si l'opération de création des directoires échoue, le script va retourner la valeur -30 (la valeaur 226 sera affiché dans le terminal).  [doc](https://linux.die.net/man/1/mkdir)
     ...
     ##### Exemple
      ...
      ```
 * #### mv spurce destination - Déplace/Renomme le fichier/directoire source dans la destination [doc](https://linux.die.net/man/1/mv).  En cas d'erreur il renvoie la valeur -40 (la valeaur 216 sera affiché dans le terminal).
